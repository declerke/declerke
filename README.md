# 🛠️ Data Engineer | Kenya-Focused Pipelines, NLP & ML Analytics
...
|---------|-------|-------|--------|
| **Kenya Financial Document Intelligence** | Airflow 3.0 · pdfplumber · HuggingFace · spaCy · dbt | 87 docs · 2,490 pages · 40,801 entities | [→](https://github.com/declerke/Kenya-Doc-Intelligence) |
| **JobSense Kenya** | Airflow 3.0 · FastAPI · pgvector · HuggingFace · Streamlit | 604 jobs · 7 sources · 604 embeddings | [→](https://github.com/declerke/Job-Sense) |
| **LedgerSync** | Airflow 3.0 · DuckDB · dbt · Evidence.dev | 1.5M rows · 9 dbt models · 2,961 alerts | [→](https://github.com/declerke/Ledger-Sync) |
| **Africa Health Investment Returns** | XGBoost · SHAP · scikit-learn | 53 countries · 1,219 rows · R²=0.945 | [→](https://github.com/declerke/Africa-Health-ML) |
| **CupCast 2026** | XGBoost · Poisson · Monte Carlo · React + Vite | 10k simulations · 7 JSON APIs · React UI | [→](https://github.com/declerke/World-Cup-2026-Forecast) |
| **Kenya News NLP Intelligence** | Airflow 3.0 · PostgreSQL · dbt · spaCy · Streamlit | 70 articles · 1,308 entities · 63 dbt tests | [→](https://github.com/declerke/Kenya-News-NLP-Intelligence) |
| **Ecommerce Analytics** | Airflow 3.0 · DuckDB · dbt · Superset | 8/8 DAG · 15 models · 54 dbt tests | [→](https://github.com/declerke/Ecommerce-Analytics) |
| **EAC Inflation Forecaster** | Prophet · World Bank API · IMF API · dbt | 50 models · 5 countries · 10 indicators | [→](https://github.com/declerke/EAC-Inflation-Forecast) |
